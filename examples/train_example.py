# example of training a model, need train func and torch dataset
import torch
...
from tryflashsim.train.args_train import get_args
from tryflashsim.train.train_funcs import train
from tryflashsim.models.base_flow import create_NDE_model

def trainer(tr_dataset, te_dataset, val_func, args_val_func):
    ...
    trh, tsh = train(
        ...
        res_epoch=res_epoch,
        val_func=val_func,
        args_val_func=args_val_func,
    )


if __name__ == "__main__":

    # DEFINE YOU DATASETS HERE
    tr_dataset, te_dataset = None, None
    trainer(tr_dataset, te_dataset)